...
def main() -> None:
    ...
    if args.workspace:
        ...
        init_workspace(
            repo_path, name, root, spec, plan, bundle_override, allow_downgrade=args.allow_downgrade
        )
    else:
        init_base(
            repo_path, bundle_override, silent=args.silent, allow_downgrade=args.allow_downgrade
        )
